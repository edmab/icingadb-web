...
(function(Icinga, $) {
    ...
    class Migrate extends Icinga.EventListener {
        ...
        prepareMigration = function($target) {
            let urls = {};
            let modules = {}
        ...
        onHandleClicked = function(event) {
            var _this = event.data.self;
        ...
        onMinimized = function(isMinimized, oldValue) {
            if (isMinimized && isMinimized !== oldValue && this.isShown()) {
                this.minimizePopup();
            }
        }

        migrateMonitoringUrls = function(urls) {
            var _this = this,
                containerIds = [],
                containerUrls = [];
        ...
        processUrlMigrationResults = function(data, textStatus, req) {
            var _this = this;
        ...
        prepareBackendCheckboxForm = function(modules) {
            let containerIds = [];
            let moduleNames = [];
        ...
        processBackendSupportResults = function(data, textStatus, req) {
        ...
        setupBackendCheckboxForm = function(modules) {
        ...
        setCheckboxState = function(html, textStatus, req) {
        ...
        setUrlMigrationReadyState = function (state) {
            this.urlMigrationReadyState = state;
        }

        changeUrlMigrationReadyState = function (state) {
        ...
        setBackendSupportReadyState = function (state) {
            this.backendSupportReadyState = state;
        }

        changeBackendSupportReadyState = function (state) {
